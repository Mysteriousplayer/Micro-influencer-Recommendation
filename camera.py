...
def func1(brands_historical,ins_historical):
...
def func2(brands_concept,ins_concept):
...
with graph1.as_default():
    ...
    # ----------------------------------------
    # function ψ
    brands_historical_v2, ins_historical_v2=func1(brands_historical,ins_historical)
    # function ρ
    brands_concept_v2, ins_concept_v2=func2(brands_concept,ins_concept)
